...
/**
 * Use this annotation to register MyBatis com.mapper interfaces when using Java Config. It performs when same work as
...
public @interface MapperScan {
   ...
   *
   * @return base package names for scanning com.mapper interface
   */
   ...
   *
   * @return classes that indicate base package for scanning com.mapper interface
   */
  ...
  /**
   * Whether enable lazy initialization of com.mapper bean.
   *
   * <p>
