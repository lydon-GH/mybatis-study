...
public class MapperScannerConfigurer
  ...
  /**
   * This property lets you set the base package for your com.mapper interface files.
   * <p>
   ...
   *
   * @param addToConfig
   *          a flag that whether add com.mapper to MyBatis or not
  ...
  /**
   * Set whether enable lazy initialization for com.mapper bean.
   * <p>
  ...
  private void processPropertyPlaceHolders() {
    ...
    if (!prcs.isEmpty() && applicationContext instanceof ConfigurableApplicationContext) {
      ...
      // contains this com.mapper scanner and post process the factory.
